...
$app->post('/api/FitbitAPI/deleteWeightLog', function ($request, $response, $args) {
    ...
    if(empty($post_data['args']['bodyWeightLogId'])) {
        $error[] = 'bodyWeightLogId';
    }
    ...
    $query_str = 'https://api.fitbit.com/1/user/'.$post_data['args']['userId'].'/body/log/weight/'.$post_data['args']['bodyWeightLogId'].'.json';
