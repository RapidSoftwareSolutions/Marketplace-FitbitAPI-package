...
$app->post('/api/FitbitAPI/searchFoods', function ($request, $response, $args) {
    ...
    $query_str = 'https://api.fitbit.com/1/foods/search.json';
    ...
    $body['query'] = urlencode($post_data['args']['query']);
