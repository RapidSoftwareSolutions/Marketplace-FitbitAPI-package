...
$app->post('/api/FitbitAPI/deleteCustomFood', function ($request, $response, $args) {
    ...
    $query_str = 'https://api.fitbit.com/1/user/'.$post_data['args']['userId'].'/foods/'.$post_data['args']['foodId'].'.json';
