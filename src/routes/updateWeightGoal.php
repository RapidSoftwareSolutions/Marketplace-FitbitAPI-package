...
$app->post('/api/FitbitAPI/updateWeightGoal', function ($request, $response, $args) {
    ...
    if(empty($post_data['args']['startWeight'])) {
        $error[] = 'startWeight';
    }
    ...
    $query_str = 'https://api.fitbit.com/1/user/'.$post_data['args']['userId'].'/body/log/weight/goal.json';
    ...
    $body['startWeight'] = $post_data['args']['startWeight'];
    if(!empty($post_data['args']['weight'])) {
