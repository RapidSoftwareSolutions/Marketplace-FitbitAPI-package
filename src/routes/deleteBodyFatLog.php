...
$app->post('/api/FitbitAPI/deleteBodyFatLog', function ($request, $response, $args) {
    ...
    if(empty($post_data['args']['bodyFatLogId'])) {
        $error[] = 'bodyFatLogId';
    }
    ...
    $query_str = 'https://api.fitbit.com/1/user/'.$post_data['args']['userId'].'/body/log/fat/'.$post_data['args']['bodyFatLogId'].'.json';
