...
$app->post('/api/FitbitAPI/getFriendsLeaderboard', function ($request, $response, $args) {
    ...
    $query_str = 'https://api.fitbit.com/1/user/'.$post_data['args']['userId'].'/friends/leaderboard.json';
