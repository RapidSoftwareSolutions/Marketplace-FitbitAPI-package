...
$app->post('/api/FitbitAPI/getAlarms', function ($request, $response, $args) {
    ...
    $query_str = 'https://api.fitbit.com/1/user/'.$post_data['args']['userId'].'/devices/tracker/'.$post_data['args']['trackerId'].'/alarms.json';
