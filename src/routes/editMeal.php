...
$app->post('/api/FitbitAPI/editMeal', function ($request, $response, $args) {
    ...
    if(empty($post_data['args']['mealId'])) {
        $error[] = 'mealId';
    }
    ...
    if(empty($post_data['args']['mealFoods'])) {
        $error[] = 'mealFoods';
    }
    ...
    $query_str = 'https://api.fitbit.com/1/user/'.$post_data['args']['userId'].'/meals/'.$post_data['args']['mealId'].'.json';
    ...
    $body['mealFoods'] = $post_data['args']['mealFoods'];
